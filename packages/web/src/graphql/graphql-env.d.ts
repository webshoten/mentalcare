...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'Mutation': { kind: 'OBJECT'; name: 'Mutation'; fields: { 'bookAppointment': { name: 'bookAppointment'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Appointment'; ofType: null; }; } }; 'createAppointment': { name: 'createAppointment'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Appointment'; ofType: null; }; } }; 'endAppointment': { name: 'endAppointment'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Appointment'; ofType: null; }; } }; 'joinAppointment': { name: 'joinAppointment'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Appointment'; ofType: null; }; } }; 'seedDatabase': { name: 'seedDatabase'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'SeedResult'; ofType: null; }; } }; }; };
